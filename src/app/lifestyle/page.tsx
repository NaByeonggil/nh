...
import { Book, Search, Calendar, Eye, User } from "lucide-react"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold">생활습관 식이요법</h1>
          </div>
          <p className="text-muted-foreground mb-6">
            암 환자를 위한 건강한 생활습관과 영양 관리 정보를 제공합니다.
            전문가가 엄선한 신뢰할 수 있는 건강 정보로 일상을 관리하세요.
          </p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm font-medium">전체 글</p>
                ...
                <CardContent className="p-4 pt-0">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <Button variant="ghost" size="sm" asChild>
                      <Link href={`/lifestyle/${content.id}`}>
                        자세히 보기
                      </Link>
                    </Button>
                  </div>
